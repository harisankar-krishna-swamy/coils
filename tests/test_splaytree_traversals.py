...
class Splay_Tree_Test_Postorder_Traversal_with_empty_Tree(TestCase):
    ...
    def test_postorder_traversal_with_empty_tree(self):
        post_order_elements = []
        for element in self._splay_tree.traversal(want_pre_order = False, want_in_order = False, want_post_order = True):
...
class Splay_Tree_Test_Inorder_Traversal_with_empty_Tree(TestCase):
    ...
    def test_inorder_traversal_with_empty_tree(self):
        in_order_elements = []
        for element in self._splay_tree.traversal(want_pre_order = False, want_in_order = True, want_post_order = False):
