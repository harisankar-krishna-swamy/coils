...
class Priority_Q_Max_Heap_Test_Empty_Q_Length(unittest.TestCase):
    def setUp(self):
...
class Priority_Q_Max_Heap_Test_Empty_Q_Iteration(unittest.TestCase):
    def setUp(self):
        self._priorityQ = PriorityQueue()
...
class Priority_Q_Max_Heap_Test_Q_Iteration(unittest.TestCase):
    def setUp(self):
        self._priorityQ = PriorityQueue()
...
class Priority_Q_Max_Heap_Test_Get_With_Empty_Q(unittest.TestCase):
    def setUp(self):
        self._priorityQ = PriorityQueue()
...
class Priority_Q_Max_Heap_Test_Q_Add(unittest.TestCase):
    def setUp(self):
...
class Priority_Q_Max_Heap_Test_Q_Add_And_Get_With_Single_Entry(unittest.TestCase):
    def setUp(self):
        self._item = 'Some Item'
        self._priority = 2
        self._priorityQ = PriorityQueue()
...
class Priority_Q_Max_Heap_Test_Q_Iter_With_Single_Entry(unittest.TestCase):
    def setUp(self):
        self._item = 'Some Item'
        self._priority = 2
        self._priorityQ = PriorityQueue()
...
class Priority_Q_Max_Heap_Test_Add_Get_Multiple_Entries(unittest.TestCase):
    def setUp(self):
...
class Priority_Q_Max_Heap_Test_Iteration_With_Multiple_Entries(unittest.TestCase):
    def setUp(self):
        self._item_priority_entries = []
...
if __name__ == '__main__':
    print('Priority Q (with max heaps) tests')
    unittest.main()